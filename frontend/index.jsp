...
<%!
    // 이미지 경로 검증 및 기본 이미지 반환 함수
    public String getValidImagePath(String imagePath) {
        if (imagePath == null || imagePath.trim().isEmpty()) {
            return "image/book1.jpg";
        }
        // 상대 경로로 시작하지 않으면 기본 경로 추가
...
<%
    ...
    try {
        ...
        recentBooks = bookDAO.getAllBooks();
        categoryBooks = bookDAO.getAllBooks();
        priceBooks = bookDAO.getAllBooks();
        dbStatus = "DB 연결 성공 - " + recentBooks.size() + "개의 책 로드됨";
    } catch (Exception e) {
        e.printStackTrace();
...
<body>
    ...
    <div class="book-list">
        ...
        <p style="margin: 0 7vw; color: #666;">등록된 책이 없습니다.</p>
        <% } %>
    </div>
